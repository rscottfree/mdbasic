#!/usr/bin/env python3
"""Produce a temporary representative D81 containing the original
...
BASEPORT = 7200
# This is test output, not a distributable built by tools/build_disk.sh.
OUT_D81 = pt.WORKDIR / "packaged_examples.d81"
