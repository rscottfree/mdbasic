...
REPO = ROOT.parent                               # repo root (pristine mdbasic.d64)
...
def extract_examples(names):
    ...
    for name in names:
        ...
        c1541(REPO / "mdbasic.d64", "-read", name, host)
...
def t_package_and_run(crt, dopack, domenu, next_port):
    ...
    pristine = pack_prg.load_image_prg(Path("/tmp/mdbasic.prg"))   # as build_cart assembled it
